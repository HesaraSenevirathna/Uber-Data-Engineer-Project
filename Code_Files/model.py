...
#SELECT
 ...
 #   passenger_phone
#FROM
 #   project.uber.silver_obt    

from pyspark import pipelines as dp

#to create target table u need to make a streaming table
# Dim Passenger
#you need to create a view table to store selected columns for the dim table because they are not stored anywhere
@dp.view 
...
@dp.view
def dim_driver_view():
    df = spark.readStream.table("project.uber.silver_obt")
